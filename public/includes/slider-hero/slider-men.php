...
<div class="swiper-container nav-slider loading">
  ...
  <div class="swiper-slide">
    <figure class="slide-bgimg" style="background-image:url('./imgs/slider/slider-male/slider%20(1).jpg')">
    ...
    <div class="swiper-slide">
    <figure class="slide-bgimg" style="background-image:url('./imgs/slider/slider-male/slider%20(2).jpg')">
    ...
    <div class="swiper-slide">
    <figure class="slide-bgimg" style="background-image:url('./imgs/slider/slider-male/slider%20(3).jpg')">
    ...
    <div class="swiper-slide">
    <figure class="slide-bgimg" style="background-image:url('./imgs/slider/slider-male/slider%20(4).jpg')">
    ...
    <div class="swiper-slide">
    <figure class="slide-bgimg" style="background-image:url('./imgs/slider/slider-male/slider%20(5).jpg')">
