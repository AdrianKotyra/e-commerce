...
<?php echo chart_cart_template("nc-circle-10","users","users.php");?>
<?php echo chart_cart_template("nc-tile-56","products","products.php");?>
<?php echo chart_cart_template("nc-favourite-28","comments","comments.php");?>
